...
## Input Sources
/usr/libexec/PlistBuddy -c "Set AppleSymbolicHotKeys:60:enabled false" ~/Library/Preferences/com.apple.symbolichotkeys.plist # Select the previous input source - Command, Option, Space
